      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <a class="nav-link" href="{{ url('/') }}">Top Agent <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('/laporan')}}">Laporan</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('/reward_page')}}">Reward Agent</a>
          </li>
      ...
      <div class="row">
        <div class="col-md-12">
          <nav class="nav nav_grid">
            ...
            <a class="nav-link nav_links" href="{{url('/reward_page')}}"><img src="images/icon_magnifier.png" alt="" srcset=""> &nbsp; Reward Agent</a>
          </nav>
        </div>
      </div>
    </div>
