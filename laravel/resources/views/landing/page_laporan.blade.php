                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    ...
                    <ul class="history_laporan">
                      ...
                      <li class="item_laporan">
                        Nominal Reward : <span class="sub_item3"><b>{{ $rwd ? 'Rp. '.number_format($rwd->nominal) : "Tidak ada reward" }}</b></span>
                        @if($rwd)
                        <a href="#" data-toggle="modal" data-target=".modal-foto-bukti" data-toggle1="tooltip" title="Lihat Bukti Transfer">
                          <i class="fa fa-info-circle text-info" style="font-size: 13px; margin-bottom: 10px;"></i>   
                        </a>
                        @endif
                      </li>
                  ...
                  @if($rwd)
                  <div class="modal modal-foto-bukti" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
